...
```
2. Susikurti du skaičių kintamuosius ir prilyginti jų skirtumą kitam kintamajam.
```

```
3. Susikurti kintamaji su sveikuoju skaičiumi, ir tada jį padidinti vienu.
```

```
4. Susikurti kintamajį su sveikuoju skaičiumi, ir tada jį sumažinti dviem.
```
